...
async function getSortedPostsData() {
  ...
  const res = await fetch("https://teachinguide.azure-api.net/course-coupon?sortCol=students&sortDir=DESC&length=12&page=1&inkw=&discount=100&language=English&cat=Office%20Productivity%7CTeaching%20%26%20Academics", {
    "headers": {
